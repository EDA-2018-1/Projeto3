/*
Trabalho feito por Rafael Bragança, Cecília Dib e Ícaro Oliveira
*/
...
// No* insere_no(No* lista, nome, tel, endereco, cep, dataNascimento, marcador){

// }

// No* arquivo_para_lista(){
//     No* lista = NULL;
//     char nome[101];
//     char tel[11];
//     char endereco[101];
...
//     FILE* file;
//     fopen(file, "contatos.txt", "a+");

//     while(fgetc(file)!= EOF){

//     fscanf(file, "%s %s %s %d %s %*s", nome, tel, endereco, cep, dataNascimento, marcador);    
//     }

//     lista = insere_no(lista, nome, tel, endereco, cep, dataNascimento, marcador);
